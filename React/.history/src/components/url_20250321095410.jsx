        ...
        <div>
            <form action="">
                ...
                <div className="flex flex-col">
                    ...
                    <label htmlFor="" className="text-lg font-medium">Image Opaci :  
                    <input type="number" id="" className="border p-2 rounded-md w-80 mb-4" onChange={(e) => setImgOpacity(e.target.value)} />
                    </label>
                </div>
