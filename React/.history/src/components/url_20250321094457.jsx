    ...
    return(
        <div>
            <form action="">
                ...
                <label htmlFor="" className="text-lg font-medium">QR Taille</label>
                ...
                <label htmlFor="">Image Heigth</label>
                <input type="number" className="border p-2 rounded-md w-80 mb-4" onChange={(e) => setLogoHeight(e.target.value)} />
                <label htmlFor="">Image Width</label>
                <input type="number" className="border p-2 rounded-md w-80 mb-4" onChange={(e) => setLogoWidth(e.target.value)} />
