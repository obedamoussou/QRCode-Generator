...
function Tel () {
    ...
    const handleImageUpload = (event) => {
      ...
      const validatePhoneNumber = (phone) => {
        // Expression régulière pour valider un numéro de téléphone (format international et local)
      ...
      const handleClick = (e) => {
        ...
        if (!validatePhoneNumber(tel)) {
          ...
          setQrValue(""); // Empêche la génération du QR Code
          return;
        }
    
        setError(""); // Efface l'erreur si le numéro est valide
        setQrValue(tel);
      };
