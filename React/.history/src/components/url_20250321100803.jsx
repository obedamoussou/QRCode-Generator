...
function Url () {
    ...
    const [positionImageX, setPositionImageX] = useState(undefined)
        ...
        <div>
            <form action="">
                ...
                <div className="flex flex-col">
                    ...
                    <input type="checkbox" value={imageCenter} onChange={setImageCenter(!imageCenter)} />
                    {imageCenter && <label htmlFor="" className="text-lg font-medium">Image Opacity :  
                    <input type="number" step="0.1" id="" className="border p-2 rounded-md w-80 mb-4" onChange={(e) => setPositionImageX(e.target.value)} />
                    </label>
                    }
                </div>
