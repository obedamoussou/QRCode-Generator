...
function Url () {
    ...
    const handleImageUpload = (event) => {
      ...
      const downloadSVG = () => {
        ...
        // Ajouter l'attribut XMLNS pour éviter que le fichier soit vide
      ...
      const downloadPNG = () => {
        ...
        // Dessiner le QR Code avec QRCodeCanvas
        const qrCanvas = document.createElement("canvas");
        const qr = new QRCodeCanvas({ value: qrValue, fgColor: color, bgColor: bgColor, size: size });
        qr.draw(qrCanvas);
