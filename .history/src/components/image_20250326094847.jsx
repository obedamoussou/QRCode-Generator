...
const QRGenerator = () => {
  ...
  const uploadImage = async (file) => {
    ...
    formData.append("upload_preset", "votre_upload_preset"); // Remplace par ton upload preset

    try {
      const res = await fetch(
        "https://api.cloudinary.com/v1_1/votre_cloud_name/image/upload", // Remplace par ton Cloud Name
        {
          method: "POST",
          body: formData,
        }
